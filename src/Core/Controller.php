...
class Controller
{
    ...
    //加選條件
    public function add_course(int $course_ID, int $user_id, string $username): bool
    {
        /*
        加選：
            同學只能加選本系的課程
    ...
    public function insert_TimeTable(int $course_ID, string $username) //這裡好像寫錯了，course id & user id 才對
    {
