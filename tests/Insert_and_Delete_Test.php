...
class Insert_and_Delete_Test extends TestCase
{
    ...
    public function testDeleteData()
    {
        ...
        $this->assertTrue(self::$controller->delete_Course(1312, "System_Program", "Computer_Science", 1, 3, 60));
        $this->assertTrue(self::$controller->delete_Course(1314, "Probability_and_Statistics", "Computer_Science", 1, 3, 50));
